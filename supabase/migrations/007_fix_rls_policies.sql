-- Fix RLS policies for google_tokens table
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view their own Google tokens" ON google_tokens;
...
-- Create proper RLS policies for google_tokens
...
-- Fix RLS policies for drive_files table
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view their own drive files" ON drive_files;
DROP POLICY IF EXISTS "Users can insert their own drive files" ON drive_files;
DROP POLICY IF EXISTS "Users can update their own drive files" ON drive_files;

-- Create proper RLS policies for drive_files
...
-- Fix RLS policies for drive_folders table
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view their own drive folders" ON drive_folders;
DROP POLICY IF EXISTS "Users can insert their own drive folders" ON drive_folders;
DROP POLICY IF EXISTS "Users can update their own drive folders" ON drive_folders;

-- Create proper RLS policies for drive_folders
